...
makeSpatialization(model = model$model, filename = tasks$`20170304150000`$task.desc$id, path = ".", file = TRUE )
# read it
data_spatialized = sf::st_read(dsn = paste0(tasks$`20170304150000`$task.desc$id, ".geojson"))
```
