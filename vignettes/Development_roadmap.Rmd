...
When spatializing data in a production environment, its __best construction reference__ must be stored as a metadata of the spatialized data.

Note that some __explorative constructions__ might not be relevant to a target variable. Hence it will be useless to use it in a batch of benchmark experiments for this target variable.
