...
Multiple combinations of the described __exploration parameters__ will be tested in various batch of benchmarks experiments. Each of them represent one of our milestones. Here below we present all of our milestones.
...
milestone3 = data.frame(id, algorithms, explanatory, hyperparameters, stations, resolution, target)
...
milestone4 = data.frame(id, algorithms, explanatory, hyperparameters, stations, resolution, target)
