...
* boxplots par learner chaque station : rmse + residuals => OK
* boxplots par learner moyenne stations : rmse + residuals => Ok
* plot obs vs response par learner => OK
* map stations par learner : rmse moyenne + moyen abs(residuals) + min, max, var, median
* ex map residuals d'une ou deux heures typique pour un learner
* plot timeseries par learner moyenne stations : residuals et stats associés (ts les learners sur meme plot) + rmse
* plot timeseries par learner chaque stations : residuals et (0 stat associée) + rmse
* map spatialiée : exemple en fct TS
* un exemple de dataset bug krigeage
* 
