...
Using the benchmark results to compute residuals and other statistics
```{r}
...
## PLus value de la combinaison Pameseb + IRM

* 1 bmr seulement PAmeseb non-corrigé
* 1 bmr Pameseb + IRM

## Robustesse

* Est-ce que les valeurs prédites aux stations sont cohérentes? Dans la gamme des observations au stations
* Analyser les résidus par station : moyenne, min, max, variance
* idem mais globalement pour chacun des learners
