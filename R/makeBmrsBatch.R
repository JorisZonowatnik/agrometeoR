...
#' @param grouping a numeric specifying the number of tasks you want to benchamrk in a single batch. Default is equal to the number of tasks
...
makeBmrsBatch <- function(
  ...
  doBenchmark = function(){
    ...
    # hack if grouping set to > than length(tasks)
