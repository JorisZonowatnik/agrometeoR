...
#' @title internal function to call the agromet API to retrieve data
#' @importFrom httr GET
...
#' @title internal function to type data called from agromet
#' @importFrom magrittr %>%
...
#' @export
typeData <- function(meta_and_records.l, table_name="cleandata"){
